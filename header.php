...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'breakerbreaker' ); ?></button>
			HIII
			<?php
			get_template_part('template-part/','navbar')
			?>
		</nav><!-- #site-navigation -->
	</header><!-- #masthead -->
